<template>
  <div class="login-wrapper">
    ...
    <div class="tw-flex tw-h-full tw-flex-col" >
         <div class="tw-pt-24 tw-flex tw-justify-center tw-items-center tw-flex-1"  >
      <div class="tw-flex tw-justify-between -tw-ml-48">
        <div class="tw-mt-10 tw-pr-24">
          <div class="tw-pb-32 tw-flex tw-justify-center -tw-mt-8">
            <video class="-tw-rotate-[26deg]" width="650" muted autoplay loop>
              <source
        ...
        <div class="-tw-ml-5">
          <div style="width: 400px">
            <div>
              ...
              <div class="tw-opacity-30 tw-mt-2">每个人都值得被看见</div>
            </div>
            <div class="mt-8">
              <v-text-field
                v-model="phone"
            ...
            <div class="tw-opacity-60 tw-flex tw-items-center tw-mt-3">
              ...
              <div class="tw-ml-1">提示：未注册用户将会自动注册</div>
            </div>
          </div>
        </div>
      </div>
...
import Header from "@/components/Nav/Nav.vue";
export default {
  props: {},
  components: {
    Footer,
  ...
  methods: {
    ...
    async login() {
      ...
      const { commitJWT, commitMe, commitUser} = useStorage();
      commitJWT(res.access_token);
      commitMe(res?.account_id);
