...
const _sfc_main = {
  ...
  methods: {
    ...
    touchstart(clientX, clientY, target) {
      ...
      this.draggingElement.parentNode.insertBefore(this.draggingElementShadow, this.draggingElement.nextSibling);
    },
    ...
    prepare() {
      ...
      for (let i = 0; i < parents.length; i++) {
        ...
        const elements = [];
        const children = library_util.$children(parent, this.itemSelector);
    ...
    createTargetShadowNode(cursorX, cursorY) {
      ...
      if (this.position && this.position.index === position.index && this.position.direction === position.direction && this.position.groupId === position.groupId) {
        return;
      }
      this.position = position;
      const {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/components/base/SortableView.vue"]]);
