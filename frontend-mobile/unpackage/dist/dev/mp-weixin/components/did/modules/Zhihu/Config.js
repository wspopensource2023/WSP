...
const _sfc_main = {
  ...
  methods: {
    ...
    async aigc() {
      ...
      const res = await library_apis.apiService.AIGCZhiHuCRD(this.uid);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/components/did/modules/Zhihu/Config.vue"]]);
