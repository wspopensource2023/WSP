...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    e: _ctx.value,
    f: common_vendor.o(($event) => $options.copy($props.config.spec.url)),
    g: common_vendor.p({
      label: "复制可以在浏览器访问的链接"
    }),
    h: common_vendor.o(($event) => $options.open($props.config.spec.url)),
    i: common_vendor.p({
      label: "在浏览器中访问"
    })
  };
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/components/did/modules/Weibo/Panel.vue"]]);
