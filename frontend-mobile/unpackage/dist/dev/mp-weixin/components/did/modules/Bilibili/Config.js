    ...
    async aigc() {
      if (!this.uid) {
        common_vendor.index.showToast({
          title: `请输入bilibili uid`,
          icon: "none",
          duration: 3e3
        });
        return;
      }
      const res = await library_apis.apiService.AIGCBilibiliCRD(this.uid);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.p({
      ...
      icon: "bilibili",
      title: "哔哩哔哩",
      description: "在数字名片上展示你在B站的账号，让访问者可以直接了解你在B站的影响力以及作品。"
    }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/components/did/modules/Bilibili/Config.vue"]]);
