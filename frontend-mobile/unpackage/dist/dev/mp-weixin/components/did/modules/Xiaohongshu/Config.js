...
const _sfc_main = {
  ...
  methods: {
    ...
    async aigc() {
      ...
      const res = await library_apis.apiService.AIGCXiaoHongShuCRD(this.uid);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.p({
      ...
      icon: "xiaohongshu",
      title: "小红书",
      description: "展示你在小红书的账号，让访问者可以直接了解你在小红书上的影响力以及分享的内容。"
    }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/components/did/modules/Xiaohongshu/Config.vue"]]);
