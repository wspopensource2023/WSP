...
const _sfc_main = {
  ...
  methods: {
    ...
    isSlideBottom() {
      if (this.modeClass == "slide-bottom") {
        return true;
      }
      return JSON.stringify(this.modeClass) === JSON.stringify({ 0: "slide-bottom" });
    },
    // 开始过度动画
    open() {
      setTimeout(() => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/uni_modules/uni-transition/components/uni-transition/uni-transition.vue"]]);
