  ...
  methods: {
    ...
    async chooseFileCallback(res) {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        let filedata = await uni_modules_uniFilePicker_components_uniFilePicker_utils.get_file_data(
          files[i],
          this.fileMediatype
        );
        filedata.progress = 0;
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue"]]);
