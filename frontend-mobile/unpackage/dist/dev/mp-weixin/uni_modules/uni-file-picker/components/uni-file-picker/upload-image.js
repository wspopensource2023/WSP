  ...
  computed: {
    ...
    borderStyle() {
      ...
      if (typeof border === "boolean") {
        obj.border = border ? "1px #ffffff2b solid" : "none";
      } else {
        ...
        obj = {
          ...
          "border-color": border && border.color || "#ffffff2b",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $props.filesList.length < $props.limit && !$props.readonly ? common_vendor.e({
    f: $props.previewImage,
    g: common_vendor.s($options.borderStyle),
    h: common_vendor.o((...args) => $options.choose && $options.choose(...args)),
    i: !$props.previewImage
  }, !$props.previewImage ? {
    j: common_vendor.s($options.borderStyle),
    k: common_vendor.o((...args) => $options.choose && $options.choose(...args))
  } : {}, {
    l: common_vendor.s($options.boxStyle)
  }) : {});
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/github/xxxxxx/frontend-wap/frontend-wap/uni_modules/uni-file-picker/components/uni-file-picker/upload-image.vue"]]);
