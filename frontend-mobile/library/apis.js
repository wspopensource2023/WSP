...
class APIService {
    ...
    async SendSMSCode(phone) {
        return this._post("SendSMSCode", { phone: phone });
    }
    ...
    async GetAccountProfile(account_id) {
        return this._post("GetAccountProfile", { account_id: account_id });
    }
    ...
    async GetCampaignDetail(campaign_id) {
        return this._post("GetCampaignDetail", { campaign_id: campaign_id });
    }
    ...
    async GetAchievement(achievement_id) {
        return this._post("GetAchievement", { achievement_id: achievement_id });
    }
    ...
    async SearchProfile(keywords) {
        return this._post("SearchProfile", { keywords: keywords });
    }
    ...
    async AIGCWeiboCRD(uid) {
        return this._post("AIGCWeiboCRD", { uid: uid });
    }

    async AIGCXiaoHongShuCRD(uid) {
        return this._post("AIGCXiaoHongShuCRD", { uid: uid });
    }

    async AIGCBilibiliCRD(uid) {
        return this._post("AIGCBilibiliCRD", { uid: uid });
    }

    async AIGCZhiHuCRD(uid) {
        return this._post("AIGCZhiHuCRD", { uid: uid });
    }
    ...
    _upload(api, filepath) {
        return new Promise((resolve, reject) => {
            uni.uploadFile({
                url: apiService.GetRequestURI(api), //仅为示例，非真实的接口地址
                filePath: filepath,
                name: "form",
...
export async function loadMe() {
    ...
    try {
        ...
        // jump to login page
        uni.navigateTo({ url: "/app/mobile/login" });
    }
}

// export const apiService = new APIService("http://192.168.3.5:5000/v1/");
export const apiService = new APIService("https://api.xxxxxx.com/v1/");
