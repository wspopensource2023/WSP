<template>
    <div>
        <div>
            <ModuleConfigHeader :groupIndex="groupIndex" :moduleIndex="moduleIndex" class="tw-pt-5" icon="story" title="故事"
                description="发布一篇文章，展示自己的故事、想法和经验。" @delete="deleteModule">
            </ModuleConfigHeader>
        </div>
        <div class="tw-pt-3 tw-px-2">
            ...
            <TextareaInput class="tw-mt-3" label="正文" v-model="config.spec.content" placeholder="请输入正文">
            </TextareaInput>
            <IconInput class="tw-mt-3" v-model="config.spec.icon"></IconInput>
        </div>
        <div class="tw-px-2 tw-grid tw-grid-cols-2 tw-gap-3 tw-mt-3">
