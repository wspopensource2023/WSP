...
export default {
    ...
    created() {
        ...
        if (this.name && this.form) {
            ...
            this.$watch(
                () => {
                    const val = this.form._getDataValue(
                        this.name,
                        this.form.localData
                    );
                    return val;
    ...
    methods: {
        ...
        async onFieldChange(value, formtrigger = true) {
            ...
            const isRequiredField = _isRequiredField(
        ...
        _isRequired() {
            if (this.form) {
                return (
                    this.required ||
                    this.form._isRequiredField(this.itemRules.rules || [])
                );
            }
        ...
        _labelWidthUnit(labelWidth) {
            ...
            return this.num2px(
                this.labelWidth
                    ? this.labelWidth
                    : labelWidth || (this.label ? 200 : "auto")
            );
            // }
            // return '65px'
        },
